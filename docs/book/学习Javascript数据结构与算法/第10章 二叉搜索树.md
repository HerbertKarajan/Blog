...
![二叉搜索树](/Blog/images/学习Javascript数据结构与算法/tree.svg)
...
![AVL](/Blog/images/学习Javascript数据结构与算法/AVL.gif)

### 实现
![AVL](/Blog/images/学习Javascript数据结构与算法/AVL.svg)
...
![AVL_LL](/Blog/images/学习Javascript数据结构与算法/AVL_LL.png)

右-右（RR）:向左的单旋转。:这种情况出现于节点的右侧子节点的高度大于左侧子节点的高度时，并且右侧子节点也是平衡或右侧较重的。

![AVL_RR](/Blog/images/学习Javascript数据结构与算法/AVL_RR.png)

左-右（LR）:先左旋再右旋。先RR再LL。:这种情况出现于左侧子节点的高度大于右侧子节点的高度，并且左侧子节点右侧较重的。

![AVL_LR](/Blog/images/学习Javascript数据结构与算法/AVL_LR.png)
...
![red_black_tree](/Blog/images/学习Javascript数据结构与算法/red_black_tree.svg)
...
![uncle_red](/Blog/images/学习Javascript数据结构与算法/uncle_red.png)

1. uncle节点是黑色的：
2.1 左—左（LL）:父节点是祖父节点的左侧子节点，节点是父节点的左侧子节点。

![uncle_black_LL](/Blog/images/学习Javascript数据结构与算法/uncle_black_LL.png)

2.2 左—右（LR）:父节点是祖父节点的左侧子节点，节点是父节点的右侧子节点。

![uncle_black_LR](/Blog/images/学习Javascript数据结构与算法/uncle_black_LR.png)

2.3 右—右（RR）:父节点是祖父节点的右侧子节点，节点是父节点的右侧子节点。

![uncle_black_RR](/Blog/images/学习Javascript数据结构与算法/uncle_black_RR.png)

2.4 左—左（RL）:父节点是祖父节点的右侧子节点，节点是父节点的左侧子节点。

![uncle_black_RL](/Blog/images/学习Javascript数据结构与算法/uncle_black_RL.png)
