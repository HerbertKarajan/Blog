...
![在这里插入图片描述](/Blog/images/blog_Vue/202104023123456.png)
...
![在这里插入图片描述](/Blog/images/blog_Vue/20190901165522572.gif)
点击action按钮，devtool中会记录异步执行时的状态。效果如下：
![在这里插入图片描述](/Blog/images/blog_Vue/20190901165711865.gif)
