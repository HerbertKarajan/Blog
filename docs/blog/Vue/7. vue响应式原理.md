...
## 1. 初始化处理
![在这里插入图片描述](/Blog/images/blog_Vue/20200117100600975.jpg)
...
```
## 2. 收集依赖、更新视图
![在这里插入图片描述](/Blog/images/blog_Vue/20200117100621309.png)
收集依赖流程：
```js
observe -> 
walk -> 
...
```
![在这里插入图片描述](/Blog/images/blog_Vue/20200117100636753.jpg)
更新视图流程：
```js
set -> 
dep.notify() -> 
