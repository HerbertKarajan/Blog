...
## 1.渐进颜色变化
 ![渐进颜色变化](/Blog/images/css效果/img1.png)  
```html
  <style>
    /* 渐进色 */
    #linear{
...
## 2.按钮进行中状态
 ![按钮进行中状态](/Blog/images/css效果/img2.gif)  
```html
  <style>
    /* 按钮 */
    button{
...
## 3.圆360度转动
 ![圆360度转动](/Blog/images/css效果/img3.gif)  
```html
  <style>
    /* 圆360度转动 */
    #circle{
...
## 4.圆上有线进行上下移动扫描
 ![圆上有线进行上下移动扫描](/Blog/images/css效果/img4.gif)  
```html
  <style>
    /* 圆上有线进行上下移动扫描 */
    #move{
...
## 5.扇形百分比图
 ![扇形百分比图](/Blog/images/css效果/img5.png)
```html
  <style>
    /* 扇形百分比图 */
    .con {
